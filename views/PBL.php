			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						...
						<li class="active"><a href="PBL.php">Satire Interface</a></li>
	...
	<div class="container">
		<div class="hero-unit">
			<h2>This is the online interface for Satire, a first order error analysis tool written in Python.</h2>
				...
				<!-- about Satire -->
				<a href="#myModal" role="button" class="btn btn-primary" data-toggle="modal"><h3>About Satire</h3></a>
				
				<!-- Modal -->
				<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 					 <div class="modal-header">
    					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">¡Á</button>
   						<h2 id="myModalLabel">About Satire</h2>
	  				</div>
	 				...
	 				<div class="modal-body">
						...
						The syntax was made to be robust and intuitive. See the examples to get an idea. The exact language
						specification can be seen here.</p>
